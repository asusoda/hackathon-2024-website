...
const TOP_SECTION = {
  TITLE: "SWHacks",
  Typed_effect: ["24 - 25 Nov", "36 hours of creation", "Win awesome prizes", "Events And Sessions"],
  SHORT_DESCRIPTION:
    "Join us on 24th and 25th of November 2024 for 36 hours of creation, innovation, & fun with over 300+ students.",
  IMG_SRC: team,
  ...
  [
    [
      ...
      },
      {
        ...
        content: "SWHacks is open to all undergraduate, high school students, and middle school students from all schools. Unfortunately, only DDU students can attend this event offline. For the rest of the other students, the event would be online."
      },
      {
    ...
    [
      ...
      },
      {
        ...
        content: "Reach us directly at (asu@thesoda.io) we would happy to help you."
      }
      ,
      {
